# Полный исправленный agent_core.py
# Основное исправление: убрал вложенные скобки в f-string, вынес вычисления в переменные для безопасности.
...
class Agent:
    ...
    def step(self, stimuli: List[Dict]):
        ...
        # Выносим вычисления для f-string
